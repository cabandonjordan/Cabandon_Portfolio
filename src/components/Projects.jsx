...
const projectsList = [
  ...
  },
 {
  ...
  },
  {
    ...
    tags: ['Flutter', 'Supabase', 'Gemini 2.5 Flash'],
    description: 'An AI-powered educational app designed to democratize learning among Filipino youth by transforming everyday environments into interactive classrooms. It utilizes real-world object identification to generate tailored learning cards and features a dynamic Kaalaman Skill Tree for tracking progress, a context-aware Conversational AI Tutor, and Pathfinder AI for personalized academic and career guidance.',
